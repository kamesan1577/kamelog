...
type ThreadCandidate = { id: string };
...
export class JevClient {
  ...
  async decide(payload: Record<string, unknown>): Promise<unknown> {
...
export class JevTagInference {
  ...
  readonly engineId = "jev";
  readonly providerId = "typesafe";
  readonly adapterVersion = TAG_ADAPTER_VERSION;
  ...
  async inferTags({
    ...
    const selected: Array<{ tag: string; support: number }> = [];
